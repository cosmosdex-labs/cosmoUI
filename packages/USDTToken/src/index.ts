...
export const networks = {
  testnet: {
    ...
    contractId: "CB25SO35B46OGVOSDSP4Q2ULMEB44NKGIJKJGPYEDTJ4A54HWHAC7H2X",
  }
} as const
...
export type DataKey = {tag: "Allowance", values: readonly [AllowanceDataKey]} | {tag: "Balance", values: readonly [string]} | {tag: "State", values: readonly [string]} | {tag: "Admin", values: void} | {tag: "TotalSupply", values: void} | {tag: "TokenOwner", values: void};
