...
export declare const networks: {
    readonly testnet: {
        ...
        readonly contractId: "CD43H4ZWDZAGYSC3O5OC6RL3LNATWQJBQJPLNZPTCNEWV5MXCNYMQ664";
    };
};
export type DataKey = {
    tag: "Admin";
...
export interface Client {
     ...
     */
    update_pool_wasm_hash: ({ admin_addr, new_hash }: {
        admin_addr: string;
        new_hash: Buffer;
    }, options?: {
        /**
     ...
     */
    create_pool: ({ token_a, token_b, lp_token_name, lp_token_symbol, salt }: {
        token_a: string;
        token_b: string;
